...
namespace SqlTracking
{
    ...
    class TrackingCommand
    {
        ...
        {
            this.Procedure = "[dbo].[InsertWorkflowInstanceEvent]";
        ...
        {
            this.Procedure = "[dbo].[InsertActivityInstanceEvent]";
        ...
        {
            this.Procedure = "[dbo].[InsertActivityScheduledEvent]";
        ...
        {
            this.Procedure = "[dbo].[InsertActivityCancelRequestedEvent]";
        ...
        {
            this.Procedure = "[dbo].[InsertFaultPropagationEvent]";
        ...
        {
            this.Procedure = "[dbo].[InsertBookmarkResumptionEvent]";
        ...
        {
            this.Procedure = "[dbo].[InsertCustomTrackingEvent]";
